    ...
    <div class="orders-container">
      <div class="header">
        ...
        <div>
          ...
          <button mat-flat-button color="warn" (click)="exportToCSV()" [disabled]="filteredOrders().length === 0">
...
export class ModeratorOrdersComponent {
  ...
  refresh() {
    this.moderatorService.getAllOrders().then(data => {
      // Sort by ID desc
      this.allOrders = (data || []).sort((a: any, b: any) => b.id - a.id);
      this.filterOrders();
    });
  }
